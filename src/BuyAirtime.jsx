...
export default function BuyAirtime({ onNavigate }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(`Recharging ₦${amount} to ${phone}`);
  };
        ...
        <div>
          ...
          <main className="p-8 max-w-6xl w-full mx-auto">
            ...
            <div className="bg-white rounded-md border border-gray-100 shadow-sm p-8 max-w-2xl mx-auto">
              <h2 className="text-base font-bold text-gray-900 mb-6">Airtime Top Up</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <select 
                    ...
                    className="w-full border border-orange-200 rounded px-3 py-2 text-xs focus:outline-none focus:border-orange-400 bg-white text-gray-700"
                  >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select 
                      ...
                      className="w-full border border-gray-200 rounded px-3 py-2 text-xs text-gray-700 focus:outline-none focus:border-gray-400 bg-white"
                    >
                      <option value="">Choose..</option>
                ...
                <button 
                  type="submit"
                  className="w-full bg-[#7C98C2] hover:bg-[#6885B0] text-white py-2.5 rounded text-xs font-semibold transition-colors mt-2 cursor-pointer"
                >
                  Recharge
                </button>
